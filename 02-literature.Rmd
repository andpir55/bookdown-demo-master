...
## What it Measurement Invariance?
...
```{r cfa, echo=FALSE, fig.cap = "Source: Wicherts & Dolan, 2010", out.width = "80%"}
...
```{r mgcfa, echo=FALSE, fig.cap = "Source: Wicherts & Dolan, 2010", out.width = "80%"}
...
Most research focus on 3 levels of measurement invariance (some authors consider there are actually more):
...
The process by which a respondent arrives at an answer, that is the relationship between the underlying score and the respondent's final answer, is called the response function. Figure 3.3 illustrates a possible response function
...
```{r tree, echo=FALSE, fig.cap = "Source: Wicherts & Dolan, 2010", out.width = "80%"}
...
#### Aproximate Invariance: a conceptually different approach 
...
```{r approximate, echo=FALSE, fig.cap = "Source: Wicherts & Dolan, 2010", out.width = "80%"}
...
Aproximate Invariance techniques:
